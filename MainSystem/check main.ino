...
void loop() {
                                                    ...
                                                    CanSatLogData.print("1\t");
        //起動時刻の更新
        unsigned long currentMillis = millis();
                                                    CanSatLogData.print("2\t");
        ...
        if(gps.location.isUpdated()){   //アップデートの実行
            ...
            gps_time = gps.time.value();
                                                    CanSatLogData.println("5\t");
        }

                                                    CanSatLogData.println("6\t");
        //地上局からのフェーズ指示
        if(Serial2.available()){

            char key = Serial2.read();
                                                    CanSatLogData.println("7\t");
            switch(key){
                case '1':
                    phase = 1;
                    break;
                ...
                case 'e':
                    ...
                    break;
                                                    ...
                                                    CanSatLogData.println("8\t");



        //各フェーズごとの記述
        switch (phase){
                                                    CanSatLogData.println("9\t");
            //########## 待機フェーズ ##########
            case 1:
