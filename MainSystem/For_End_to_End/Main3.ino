...
void setup() {
    ...
    //無線通信
    Serial.begin(115200, SERIAL_8N1, 16, 17); //関数内の引数はデータ通信レート，わからん，RXピン，TXピン
            ...
            if (Serial.available() ){
                ...
                if (nowAngle1 != newAngle1){
                    if (newAngle1 <= 180 && newAngle1 >= 0){
                        Serial.write("WARMING: MOTER1 IS ROTATING \n");
